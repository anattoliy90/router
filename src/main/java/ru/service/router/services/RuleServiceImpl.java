...
import ru.service.router.exception.InternalServerException;
    ...
    private void checkParameterType(List<Parameter> paramsFromDb, Map<String, String> params) {
        for (Parameter parameter : paramsFromDb) {
            ...
            try {
                ...
                throw new InternalServerException(messageSource.getMessage("C001", null, LocaleContextHolder.getLocale()));
            }
        }
    }
